...
%
We will use the program in Figure~\ref{fig:relwork:example} as a running example to illustrate the tradeoffs in each approach to the environment problem.
