...
A significantly more challenging class of high-level languages are those that are never compiled, but source-interpreted, such as Python, JavaScript, Ruby, or Lua.
%
These languages are a difficult target for symbolic execution because they have complex semantics, they are under-specified, and the language features evolve rapidly from one version to the other.
%
This resulted in existing symbolic execution engines targeting only domain-specific subsets of these languages.
