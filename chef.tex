The previous chapter showed that symbolic models can address the environment problem when the environment interface is stable and well-documented, as it is the case with operating system interfaces.
%
